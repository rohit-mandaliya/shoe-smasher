                    ...
                    <div class="card-body">
                        ...
                        <div class="app-brand justify-content-center">
                            <a href="" class="app-brand-link gap-2">
                                <img src="http://127.0.0.1:8000/assets/img/favicon/logo-black.png" height="60" width="60">
                                <img src="http://127.0.0.1:8000/assets/img/favicon/logo_text_black.png" height="60" width="150">
                            </a>
                        </div>
                        <!-- /Logo -->
                        <h4 class="mb-2">{{ __('Welcome to ShoeSmasher!') }} 👋</h4>
                        ...
                        <form action="{{ route('admin.login-admin') }}" method='POST'>
                            @csrf
                            <div class="mb-3">

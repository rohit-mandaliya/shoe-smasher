...
@section('content')
    <div class="row">
        ...
        <div class="col-12">
            <div class="card">
                <h5 class="card-header">{{ __('Add Shoe') }}</h5>
                <hr class="mt-0">
                <div class="card-body">
                    <form action="{{ route('shoes.store') }}" class="row g-3 fv-plugins-bootstrap5 fv-plugins-framework"
                        ...
                        <div class="col-md-12 dropzone needsclick dz-clickable imageClick" onclick="imageClick()"
                            id="dropzone-basic">
                            <i class="iconDisplay fa-solid fa-circle-xmark fa-xl d-none"
                                style="position: absolute;top: 20px;
                        right: 15px;"></i>
                            <img src="" class="d-none" id="imageDisplay">
                            <div class="dz-message needsclick fileUpload">
                        ...
                        <div class="col-md-4 fv-plugins-icon-container">
                            ...
                            <div class="input-group input-group-merge mt-2">
                                <input type="text" name="discount" onkeypress="return /[0-9]/i.test(event.key)"
                                    placeholder="Ex. 10" class="form-control" value="{{ old('discount') }}">
                                <span class="input-group-text">
                                ...
                                <div class="position-relative">
                                    <select name="size[]" id="size_shoe" class="select2 form-select" multiple=""
                                        ...
                                        @foreach ($shoeSizes as $key => $value)
                                            <option value={{ $key }} @selected(old('size') == $value)>
                                                {{ 'size ' . $value }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="col-md-12 d-none" id="stockSize">
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/custom/image-upload.js') }}"></script>

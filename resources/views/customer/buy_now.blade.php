    ...
    <div id="wizard-checkout" class="bs-stepper wizard-icons wizard-icons-example mt-2">
        ...
        <div class="bs-stepper-content border-top">
            ...
            <div id="checkout-cart" class="content">
                <div class="row">
                    <!-- Cart left -->
                    <div class="col-xl-8 mb-3 mb-xl-0 border rounded p-3">
                        <!-- Shopping bag -->
                        {{-- <h5>My Shopping Bag (2 Items)</h5> --}}
                        <div class="d-flex gap-3">
                            <img src="{{ asset('images/shoes/' . $shoe->image) }}" alt="google home" height="400"
                                width="400" />
                            <div class="flex-grow-1">
                                <div class="row">
                                    <div class="col-md-8">
                                        <h2>{{ $shoe->name }}</h2><br>
                                        <h4 class="me-1 mt-0 text-secondary">{{ $shoe->description }}</h4><br>

                                        <div class="text-muted mb-1 d-flex flex-wrap">
                                            <h4 class="me-1">Size: <b>{{ $size }}</b></h4>
                                            <h4 class="mt-1 ms-2 text-primary">(In Stock)</h4>
                                        </div>
                                        <h4 class="me-1">Quantity: <b>{{ $quantity }}</b></h4>
                                    </div>
                                    {{-- <div class="col-md-4">
                                            <div class="text-md-end">
                                                <div class="my-2 my-md-4">
                                                    <span class="text-primary">₹
                                                        {{ $quantity * round($item->shoes->price - ($item->shoes->price * $item->shoes->discount) / 100) }}/</span><s
                        ...
                        <div class="border rounded p-3 mb-3">
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-6 text-primary text-end">₹
                                    {{ $quantity * $shoe->price - $quantity * round($shoe->price - ($shoe->price * $shoe->discount) / 100) }}
                                </dd>

                                <dt class="col-6 fw-normal">Order Total</dt>
                                <dd class="col-6 text-end">
                                    ₹{{ $quantity * round($shoe->price - ($shoe->price * $shoe->discount) / 100) }}
                                </dd>
                            ...
                            <dl class="row mb-0">
                                ...
                                <dd class="col-6 fw-semibold text-end mb-0">
                                    ₹{{ $quantity * round($shoe->price - ($shoe->price * $shoe->discount) / 100) . '.00' }}
                                </dd>
                            </dl>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-6">
                        ...
                        <div class="tab-content px-0" id="paymentTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-cc" role="tabpanel"
                                ...
                                <form action="{{ route('customer.orderConfirmed') }}" id="orderConfirmed"
                                    method="post">
                                    @csrf
                                    <div class="row g-3">
                                        <div class="col-12">
                                        ...
                                        <div class="col-6 col-md-3">
                                            ...
                                            <input type="hidden" name="shoe_ids" value="{{ $shoe->id }}">
                                            <input type="hidden" name="size" value="{{ $size }}">
                                            <input type="hidden" name="quantity" value="{{ $quantity }}">
                                            <input type="hidden" name="total_price"
                                                value="{{ $quantity * round($shoe->price - ($shoe->price * $shoe->discount) / 100) }}">
                                        </div>
                            ...
                            <div class="tab-pane fade" id="pills-cod" role="tabpanel" aria-labelledby="pills-cod-tab">
                                ...
                                <input type="hidden" name="quantity" value="{{ $quantity }}"
                                    form="orderConfirmed">
                                <input type="hidden" name="size" value="{{ $size }}" form="orderConfirmed">
                    ...
                    <div class="col-xl-6">
                        <div class="border rounded p-3">
                            ...
                            <dl class="row">
                                ...
                                <dd class="col-6 fw-semibold text-end mb-0">
                                    <span
                                        class="badge bg-label-primary">{{ config('constants.location.' . $address->location) }}</span>
                                </dd>
                            </dl>
                            <!-- Address Details -->
                            <address>
                                <span class="fw-semibold"> {{ $address->customer->name }}</span><br />
                                {{ $address->address }}
                            </address>
                        </div>
                    </div>
